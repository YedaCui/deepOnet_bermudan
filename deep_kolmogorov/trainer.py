...
HYPERCONFIGS = {
    ...
    "avg_bs_bermudan_put_frezed_test_with_num_ex_10": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
     ...
     "avg_bs_bermudan_put_free_test_with_num_ex_2": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
     ...
     "avg_bs_bermudan_put_free_test_with_num_ex_5": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
     ...
     "avg_bs_bermudan_put_free_test_with_num_ex_10": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
     ...
     "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
        ...
        "unfreeze": "all",
        "unfreeze_patience": 1,
        "data_path": "/home/ycui/Documents/deepOnet_bermudan/data/free_test_num_ex_2_max_4.4",
        "n_iterations": 30,
        "size_t_x_u": [0,1,4],
        "size_sensor": 100,
        "num_width" : tune.grid_search([35, 55, 75]),
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
        "payoff": "GRF",
        "sensor": torch.exp(torch.linspace(-4, 4, 100)),
        "kernel": "RBF", 
        "length_scale":10,
        "bermudan": "Bermudan_1D",
        "T": 1,
        ...
        "unfreeze": "all",
        "unfreeze_patience": 1,
        "data_path": "/home/ycui/Documents/deepOnet_bermudan/data/free_test_num_ex_2_max_4",
        "n_iterations": 30,
        "size_t_x_u": [0,1,4],
        "size_sensor": 100,
        "num_width" : tune.grid_search([35, 55, 75]),
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4_var_scale_2": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
        ...
        "unfreeze": "all",
        "unfreeze_patience": 1,
        "data_path": "/home/ycui/Documents/deepOnet_bermudan/data/free_test_num_ex_2_max_4_var_scale_2",
        "n_iterations": 30,
        "size_t_x_u": [0,1,4],
        "size_sensor": 100,
        "num_width" : tune.grid_search([35, 55, 75]),
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4_var_scale_2": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4_var_scale_3": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4_var_scale_5": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4_var_scale_0.5": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4_var_scale_2_length_scale_50": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
        ...
        "unfreeze": "all",
        "unfreeze_patience": 1,
        "data_path": "/home/ycui/Documents/deepOnet_bermudan/data/free_test_num_ex_2_max_4.4_var_scale_2_length_scale_50",
        "n_iterations": 30,
        "size_t_x_u": [0,1,4],
        "size_sensor": 100,
        "num_width" : tune.grid_search([35, 55, 75]),
    ...
    "avg_bs_bermudan_put_free_test_num_ex_2_max_4.4_var_scale_2_length_scale_100": {
        "seed": tune.grid_search([0]),
        "checkpoint": True,
        "pde": "BSr",
        "net": "DeepONet",
        ...
        "unfreeze": "all",
        "unfreeze_patience": 1,
        "data_path": "/home/ycui/Documents/deepOnet_bermudan/data/free_test_num_ex_2_max_4.4_var_scale_2_length_scale_100",
        "n_iterations": 30,
        "size_t_x_u": [0,1,4],
        "size_sensor": 100,
        "num_width" : tune.grid_search([35, 55, 75]),
